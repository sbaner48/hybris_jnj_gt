 ...
 *
 */
package com.jnj.b2b.uiaddon.hmc;
...
/**
 * Provides necessary meta information about the uiaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.5.1.0
 */
public class UiaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(UiaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.jnj.b2b.uiaddon.hmc.locales";
