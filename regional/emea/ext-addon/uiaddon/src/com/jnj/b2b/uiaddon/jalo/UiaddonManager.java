 ...
 *
 */
package com.jnj.b2b.uiaddon.jalo;
...
import com.jnj.b2b.uiaddon.constants.UiaddonConstants;



/**
 * This is the extension manager of the Uiaddon extension.
 */
public class UiaddonManager extends GeneratedUiaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(UiaddonManager.class.getName());
	 ...
	 */
	public static UiaddonManager getInstance()
	{
		return (UiaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				UiaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public UiaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of UiaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of UiaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of UiaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
