...
/**
 * This is the extension manager of the Masterstore extension.
 */
public class MasterstoreManager extends GeneratedMasterstoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MasterstoreManager.class.getName());
	 ...
	 */
	public static MasterstoreManager getInstance()
	{
		return (MasterstoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MasterstoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MasterstoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MasterstoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MasterstoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MasterstoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
