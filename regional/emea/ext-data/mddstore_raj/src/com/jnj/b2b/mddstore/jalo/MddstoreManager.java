 ...
 *  
 */
package com.jnj.b2b.mddstore.jalo;
...
/**
 * This is the extension manager of the Mddstore extension.
 */
public class MddstoreManager extends GeneratedMddstoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MddstoreManager.class.getName());
	 ...
	 */
	public static MddstoreManager getInstance()
	{
		return (MddstoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MddstoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MddstoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MddstoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MddstoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MddstoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
