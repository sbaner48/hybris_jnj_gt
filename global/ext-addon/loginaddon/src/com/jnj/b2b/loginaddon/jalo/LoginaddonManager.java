...
/**
 * This is the extension manager of the Loginaddon extension.
 */
public class LoginaddonManager extends GeneratedLoginaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(LoginaddonManager.class.getName());
	 ...
	 */
	public static LoginaddonManager getInstance()
	{
		return (LoginaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				LoginaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public LoginaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of LoginaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of LoginaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of LoginaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
