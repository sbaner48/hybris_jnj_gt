...
/**
 * This is the extension manager of the Jnjb2bstore extension.
 */
public class Jnjb2bstoreManager extends GeneratedJnjb2bstoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Jnjb2bstoreManager.class.getName());
	 ...
	 */
	public static Jnjb2bstoreManager getInstance()
	{
		return (Jnjb2bstoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Jnjb2bstoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Jnjb2bstoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Jnjb2bstoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Jnjb2bstoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Jnjb2bstoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
