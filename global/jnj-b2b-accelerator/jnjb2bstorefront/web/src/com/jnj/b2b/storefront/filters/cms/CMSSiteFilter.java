 ...
 * {@link de.hybris.platform.cms2.misc.AbstractPreviewServlet} which actually is obsolete. All necessary logic was adapted and
 * moved here. This is a spring configured filter that is executed by the PlatformFilterChain.
 */
public class CMSSiteFilter extends OncePerRequestFilter implements CMSFilter
{
	...
	/**
	 * Processing preview request (i.e. request with additional parameters like {@link CMSFilter#PREVIEW_TOKEN} requested from
	 * cmscockpit) )
	 * <p/>
	 * <b>Note:</b> Processing preview data in order to generate target URL, and load necessary information in user session
	 * <ul>
	 * <li>Initialize information (Active CMSSite, Catalog versions,Current catalog version ) information getting from valid
	 * Preview Data</li>
	...
	/**
	 * Filters the preview language to a language supported by the site. If the requested preview language is not supported,
	 * returns the default site language instead.
	 * 
	 * @param httpRequest
	 *            current request
