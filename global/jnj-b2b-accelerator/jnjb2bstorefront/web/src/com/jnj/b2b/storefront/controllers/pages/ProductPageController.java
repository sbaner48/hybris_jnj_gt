...
public class ProductPageController extends AbstractPageController
{
    ...
    //Service should not be used in the controller.
    @Deprecated
			...
			final HttpServletRequest request, List<ProductOption> extraOptions) throws CMSItemNotFoundException
	{
        ...
        final List<ProductOption> options = new ArrayList<>(Arrays.asList(ProductOption.VARIANT_FIRST_VARIANT, ProductOption.BASIC, ProductOption.URL,
