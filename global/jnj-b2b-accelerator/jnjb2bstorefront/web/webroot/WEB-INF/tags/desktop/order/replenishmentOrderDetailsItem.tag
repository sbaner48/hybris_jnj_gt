			...
			<c:forEach items="${order.entries}" var="entry">
				...
				<tr class="item">
					...
					<td headers="header7" class="multidimensional">
						<a href="#" id="QuantityProductToggle_${entry.product.code}" class="showQuantityProduct updateQuantityProduct-toggle">+</a> <!-- multidimensional test seems to be missing -->
					</td>
				</tr>
