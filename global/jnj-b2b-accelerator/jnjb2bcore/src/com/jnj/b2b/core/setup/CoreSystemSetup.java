...
public class CoreSystemSetup extends AbstractSystemSetup
{
	...
	{
		importImpexFile(context, "/jnjb2bcore/import/essential-data.impex");
		importImpexFile(context, "/jnjb2bcore/import/countries.impex");
		importImpexFile(context, "/jnjb2bcore/import/delivery-modes.impex");

		importImpexFile(context, "/jnjb2bcore/import/themes.impex");
	}
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		{
			importImpexFile(context, "/jnjb2bcore/import/cockpits/cmscockpit/cmscockpit-users.impex");
			importImpexFile(context, "/jnjb2bcore/import/cockpits/cmscockpit/cmscockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("btgcockpit"))
		{
			importImpexFile(context, "/jnjb2bcore/import/cockpits/cmscockpit/btgcockpit-users.impex");
			importImpexFile(context, "/jnjb2bcore/import/cockpits/cmscockpit/btgcockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("productcockpit"))
		{
			importImpexFile(context, "/jnjb2bcore/import/cockpits/productcockpit/productcockpit-users.impex");
			importImpexFile(context, "/jnjb2bcore/import/cockpits/productcockpit/productcockpit-access-rights.impex");
			importImpexFile(context, "/jnjb2bcore/import/cockpits/productcockpit/productcockpit-constraints.impex");
		}

		if (importAccessRights && extensionNames.contains("cscockpit"))
		{
			importImpexFile(context, "/jnjb2bcore/import/cockpits/cscockpit/cscockpit-users.impex");
			importImpexFile(context, "/jnjb2bcore/import/cockpits/cscockpit/cscockpit-access-rights.impex");
		}

		if (extensionNames.contains("mcc"))
		{
			importImpexFile(context, "/jnjb2bcore/import/mcc-sites-links.impex");
		}
	...
	public PerformResult executeCatalogSyncJob(final SystemSetupContext context, final String catalogName)
	{
		...
		importImpexFile(context, "/jnjb2bcore/import/catalogs-sync.impex", true);
	...
	protected void importProductCatalog(final SystemSetupContext context, final String catalogName)
	{
		...
		importImpexFile(context, "/jnjb2bcore/import/productCatalogs/" + catalogName + "ProductCatalog/catalog.impex",
				true);
	...
	protected void createAndActivateSolrIndex(final SystemSetupContext context, final String storeName)
	{
		...
		importImpexFile(context, "/jnjb2bcore/import/stores/" + storeName + "/solr.impex");

		createSolrIndexerCronJobs(storeName + "Index");

		importImpexFile(context, "/jnjb2bcore/import/stores/" + storeName + "/solrtrigger.impex");
	...
	protected void importContentCatalog(final SystemSetupContext context, final String catalogName)
	{
		...
		importImpexFile(context, "/jnjb2bcore/import/contentCatalogs/" + catalogName + "ContentCatalog/catalog.impex",
				true);
		importImpexFile(context, "/jnjb2bcore/import/contentCatalogs/" + catalogName + "ContentCatalog/cms-content.impex",
				false);
		importImpexFile(context, "/jnjb2bcore/import/contentCatalogs/" + catalogName
	...
	protected void importStore(final SystemSetupContext context, final String storeName)
	{
		...
		importImpexFile(context, "/jnjb2bcore/import/stores/" + storeName + "/store.impex");
		importImpexFile(context, "/jnjb2bcore/import/stores/" + storeName + "/site.impex");
