...
import com.jnj.b2b.core.jalo.MultipleCatalogsSyncCronJob;
import com.jnj.b2b.core.jalo.PowertoolsSizeVariantProduct;
import com.jnj.b2b.core.jalo.btg.BTGOrganizationTotalSpentInCurrencyLastYearOperand;
import com.jnj.b2b.core.jalo.btg.BTGOrganizationTotalSpentInCurrencyRelativeDatesOperand;
import com.jnj.b2b.core.jalo.btg.OrganizationOrderStatistics;
import com.jnj.b2b.core.jalo.btg.OrganizationOrdersReportingCronJob;
...
public abstract class GeneratedJnjb2bCoreManager extends Extension
{
	...
	public BTGOrganizationTotalSpentInCurrencyLastYearOperand createBTGOrganizationTotalSpentInCurrencyLastYearOperand(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( Jnjb2bCoreConstants.TC.BTGORGANIZATIONTOTALSPENTINCURRENCYLASTYEAROPERAND );
	...
	public BTGOrganizationTotalSpentInCurrencyRelativeDatesOperand createBTGOrganizationTotalSpentInCurrencyRelativeDatesOperand(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( Jnjb2bCoreConstants.TC.BTGORGANIZATIONTOTALSPENTINCURRENCYRELATIVEDATESOPERAND );
	...
	public HeaderNavigationComponent createHeaderNavigationComponent(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( Jnjb2bCoreConstants.TC.HEADERNAVIGATIONCOMPONENT );
	...
	public MultipleCatalogsSyncCronJob createMultipleCatalogsSyncCronJob(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( Jnjb2bCoreConstants.TC.MULTIPLECATALOGSSYNCCRONJOB );
	...
	public OrganizationOrdersReportingCronJob createOrganizationOrdersReportingCronJob(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( Jnjb2bCoreConstants.TC.ORGANIZATIONORDERSREPORTINGCRONJOB );
	...
	public OrganizationOrderStatistics createOrganizationOrderStatistics(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( Jnjb2bCoreConstants.TC.ORGANIZATIONORDERSTATISTICS );
	...
	public PowertoolsSizeVariantProduct createPowertoolsSizeVariantProduct(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( Jnjb2bCoreConstants.TC.POWERTOOLSSIZEVARIANTPRODUCT );
