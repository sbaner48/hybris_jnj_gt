...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			...
			"CronJob",
			com.jnj.b2b.core.jalo.MultipleCatalogsSyncCronJob.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"VariantProduct",
			com.jnj.b2b.core.jalo.PowertoolsSizeVariantProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"GenericItem",
			com.jnj.b2b.core.jalo.btg.OrganizationOrderStatistics.class,
			"de.hybris.platform.persistence.jnjb2bcore_OrganizationOrderStatistics",
			false,
			null,
			false
		);
		...
		createItemType(
			...
			"CronJob",
			com.jnj.b2b.core.jalo.btg.OrganizationOrdersReportingCronJob.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			com.jnj.b2b.core.jalo.btg.BTGOrganizationTotalSpentInCurrencyLastYearOperand.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"BTGOrganizationTotalSpentInCurrencyLastYearOperand",
			com.jnj.b2b.core.jalo.btg.BTGOrganizationTotalSpentInCurrencyRelativeDatesOperand.class,
			null,
			false,
			null,
			false
