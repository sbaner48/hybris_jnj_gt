...
import com.jnj.b2b.initialdata.constants.Jnjb2bInitialDataConstants;
 ...
 */
@SystemSetup(extension = Jnjb2bInitialDataConstants.EXTENSIONNAME)
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		// importCommonData(context, "jnjb2binitialdata");
		// This would import a standard store: (one basestore, one cmssite, one product catalog, one content catalog)
		// importStoreInitialData(context, "jnjb2binitialdata", "yb2baccelerator", "yb2baccelerator", Collections.singletonList("yb2baccelerator"));
