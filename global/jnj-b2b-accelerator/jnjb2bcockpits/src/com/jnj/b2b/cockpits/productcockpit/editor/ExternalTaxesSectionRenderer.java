			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("jnjb2bcockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("jnjb2bcockpits.product.externalTaxes"));
